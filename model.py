...
class ModelClass(EconModelClass):
    ...
    def setup(self):
        ...
        # Grids
        par.N_a, par.a_sp, par.a_min, par.a_max = 3, 1.5, 0.1, 3_000_000
        par.N_s, par.s_sp, par.s_min, par.s_max = 3, 1.2, 0.0, 3_500_000
        par.N_k, par.k_sp, par.k_min, par.k_max = 3, 1.2, 0.0, 100
